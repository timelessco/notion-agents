...
export function ViewOptions({ content, docUrl, title }: ViewOptionsProps) {
  ...
  const githubDiscussionUrl = `https://github.com/udecode/plate/discussions/new?${new URLSearchParams(
    {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start">
        ...
        <DropdownMenuItem asChild>
          <a href={gpt} rel="noreferrer noopener" target="_blank">
            <svg
              className="h-4 w-4"
        ...
        <DropdownMenuItem asChild>
          <a href={claude} rel="noreferrer noopener" target="_blank">
            <svg
              className="h-4 w-4"
              fill="text-foreground"
              role="img"
