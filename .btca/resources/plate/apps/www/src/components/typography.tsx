...
export const H1 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h1
    className={cn("group mt-2 scroll-m-20 font-bold font-heading text-4xl", className)}
    {...props}
  />
);
...
export const H5 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h5
    className={cn("group mt-8 scroll-m-20 font-semibold text-lg tracking-tight", className)}
    {...props}
  />
);
...
export const H6 = ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <h6
    className={cn("group mt-8 scroll-m-20 font-semibold text-base tracking-tight", className)}
    {...props}
  />
);

export const P = ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
  <p className={cn("not-first:mt-6 leading-7 [&_code]:text-sm", className)} {...props} />
);
...
export const OL = ({ className, ...props }: React.HTMLAttributes<HTMLOListElement>) => (
  <ol
    className={cn("group first:!mt-0 my-4 ml-6 list-decimal group-data-list:my-2", className)}
    data-list
    {...props}
  />
);
...
export const Image = ({ alt, className, ...props }: React.ImgHTMLAttributes<HTMLImageElement>) => (
