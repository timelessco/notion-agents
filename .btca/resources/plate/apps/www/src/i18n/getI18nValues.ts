...
import { equationValue as equationValueCn } from "@/registry/examples/values/cn/equation-value";
import { excalidrawValue as excalidrawValueCn } from "@/registry/examples/values/cn/excalidraw-value";
import {
...
export const getI18nValues = (locale: string) => i18n[locale as keyof typeof i18n];
