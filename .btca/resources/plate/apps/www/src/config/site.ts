export const siteConfig = {
  ...
  links: {
    ...
    plateProExample: (id: string) => `https://pro.platejs.org/docs/examples/${id}`,
  },
  name: "Plate",
  navItems: [
    {
  ...
  registryUrl:
    process.env.NODE_ENV === "development" ? "http://localhost:3000/rd/" : "https://platejs.org/r/",
  url: process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://platejs.org",
};
