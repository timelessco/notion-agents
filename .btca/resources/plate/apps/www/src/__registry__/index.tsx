...
export const Index: Record<string, any> = {
  ...
  "ai-menu": {
    ...
    meta: {
      docs: [
        ...
        { route: "https://pro.platejs.org/docs/components/ai-menu", title: "AI Menu" },
      ],
  ...
  "comment-toolbar-button": {
    ...
    type: "registry:ui",
    registryDependencies: ["https://platejs.org/r/comment-kit.json"],
    files: [
      {
  ...
  "history-toolbar-button": {
    ...
    meta: {
      docs: [{ route: "https://docs.slatejs.org/libraries/slate-history", title: "Slate History" }],
      examples: ["basic-nodes-demo"],
    },
  },
  "list-toolbar-button": {
  ...
  "more-toolbar-button": {
    ...
    meta: {
      docs: [{ route: "https://pro.platejs.org/docs/components/more-toolbar-button" }],
      examples: ["basic-marks-demo", "basic-nodes-pro"],
    },
  },
  "resize-handle": {
  ...
  "turn-into-toolbar-button": {
    ...
    meta: {
      docs: [{ route: "https://pro.platejs.org/docs/components/turn-into-toolbar-button" }],
  ...
  "ai-node": {
    ...
    meta: {
      docs: [
        { route: "/docs/ai", title: "AI" },
        { route: "https://pro.platejs.org/docs/components/ai-node", title: "AI Leaf" },
      ],
      examples: ["ai-demo", "ai-pro"],
      label: "New",
    },
  ...
  "callout-node": {
    ...
    type: "registry:ui",
    registryDependencies: ["https://platejs.org/r/emoji-toolbar-button.json"],
    files: [
      {
  ...
  "column-node": {
    ...
    type: "registry:ui",
    registryDependencies: ["https://platejs.org/r/resize-handle.json"],
    files: [
      {
  ...
  "equation-node": {
    ...
    meta: {
      docs: [{ route: "http://localhost:3000/docs/equation", title: "Equation" }],
  ...
  "callout-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/callout-node.json"],
    files: [
      {
  ...
  "code-block-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/code-block-node.json"],
    files: [
      {
  ...
  "code-drawing-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/code-drawing-node.json"],
    files: [
      {
  ...
  "column-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/column-node.json"],
    files: [
      {
  ...
  "comment-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/comment-node.json"],
    files: [
      {
  ...
  "date-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/date-node.json"],
    files: [
      {
  ...
  "excalidraw-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/excalidraw-node.json"],
    files: [
      {
  ...
  "link-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/link-node.json"],
    files: [
      {
  ...
  "math-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/equation-node.json"],
    files: [
      {
  ...
  "mention-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/mention-node.json"],
    files: [
      {
  ...
  "suggestion-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/suggestion-node.json"],
    files: [
      {
  ...
  "table-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/table-node.json"],
    files: [
      {
  ...
  "toc-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/toc-node.json"],
    files: [
      {
  ...
  "toggle-base-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/toggle-node.json"],
    files: [
      {
  ...
  "dnd-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/block-draggable.json"],
    files: [
      {
  ...
  "fixed-toolbar-classic-kit": {
    ...
    component: React.lazy(async () => {
      const mod =
        await import("@/registry/components/editor/plugins/fixed-toolbar-classic-kit.tsx");
      const exportName =
        Object.keys(mod).find(
          (key) => typeof mod[key] === "function" || typeof mod[key] === "object",
        ) || item.name;
  ...
  "floating-toolbar-classic-kit": {
    ...
    component: React.lazy(async () => {
      const mod =
        await import("@/registry/components/editor/plugins/floating-toolbar-classic-kit.tsx");
      const exportName =
        Object.keys(mod).find(
          (key) => typeof mod[key] === "function" || typeof mod[key] === "object",
        ) || item.name;
  ...
  "slash-kit": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/slash-node.json"],
    files: [
      {
  ...
  "use-chat": {
    ...
    description: "",
    type: "registry:component",
    registryDependencies: ["https://platejs.org/r/ai-kit.json"],
    files: [
      {
  ...
  "code-drawing-demo": {
    ...
    meta: {
      docs: [{ route: "/docs/code-drawing", title: "Code Drawing" }],
      label: "New",
      registry: false,
    },
  },
  ...
  "list-classic-demo": {
    ...
    registryDependencies: [
      "https://platejs.org/r/editor-kit.json",
      "https://platejs.org/r/autoformat-classic-kit.json",
      "https://platejs.org/r/fixed-toolbar-classic-kit.json",
      "https://platejs.org/r/list-classic-kit.json",
      "https://platejs.org/r/editor.json",
    ],
    files: [
      {
  ...
  "find-replace-demo": {
    ...
    registryDependencies: [
      "https://platejs.org/r/fixed-toolbar.json",
      "@shadcn/input",
      "https://platejs.org/r/search-highlight-node.json",
      "https://platejs.org/r/editor-kit.json",
    ],
    files: [
      {
  ...
  "basic-nodes-demo": {
    ...
    meta: {
      docs: [{ route: "/docs/basic-blocks", title: "Basic Elements" }],
  ...
  "list-demo": {
    ...
    meta: {
      docs: [
        { route: "/docs/indent", title: "Indent" },
