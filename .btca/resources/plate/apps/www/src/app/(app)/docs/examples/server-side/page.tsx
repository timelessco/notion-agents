...
import { createSlateEditor, ExitBreakPlugin, TrailingBlockPlugin } from "platejs";
...
export default function RSCPage() {
  ...
  return (
    <DocContent category="example" doc={mockDoc} toc={[]}>
      ...
      <P>
        Plate can be utilized in server-side environments, enabling operations like content
        manipulation without a browser. This is particularly useful for scenarios such as generating
        static content, processing editor content on the server, or working with React Server
        Components.
      </P>

      <H3>Creating a Server-Side Editor</H3>
      <P>
        To use Plate on the server, you can leverage the <Code>createSlateEditor</Code>
        function. This allows you to create and manipulate Slate documents without a DOM
        environment.
      </P>
      ...
      <P className="mb-8">
        ...
        <Link href="/docs/markdown">generating Markdown from a Slate value</Link> within a React
        Server Component:
      </P>
