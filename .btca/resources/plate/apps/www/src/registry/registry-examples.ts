...
export const examples: Registry["items"] = [
  ...
  {
    dependencies: ["@platejs/basic-nodes", "@platejs/basic-nodes", "@platejs/media"],
    files: [
      {
  ...
  },
  {
    ...
    registryDependencies: ["copilot-kit", "editor-kit", "markdown-joiner-transform"],
    type: "registry:example",
  },
  {
...
export const demoExamples: Registry["items"] = (
  [
    ...
    },
    {
      ...
      registryDependencies: ["editor-kit", "@shadcn/input", "@shadcn/label", "@shadcn/radio-group"],
      type: "registry:example",
    },
    {
    ...
    },
    {
      ...
      registryDependencies: ["comment-kit", "discussion-kit", "comment-node", "editor-kit"],
      type: "registry:example",
    },
    {
...
export const internalExamples: Registry["items"] = (
  [
    ...
    {
      files: [{ path: "examples/potion-iframe-demo.tsx", type: "registry:example" }],
