...
export const autoformatValue: any = (
  <fragment>
    <hh2>自动格式化</hh2>
    <hp>
      通过启用自动格式化功能来增强你的写作体验。添加类似 Markdown 的快捷方式，在输入时自动应用格式。
    </hp>
    <hp>在输入时，试试这些标记规则：</hp>
    <hp indent={1} listStyleType="disc">
      在文本两侧输入 <htext code>**</htext> 或 <htext code>__</htext> 来添加 **粗体** 标记。
    </hp>
    <hp indent={1} listStyleType="disc">
      在文本两侧输入 <htext code>*</htext> 或 <htext code>_</htext> 来添加 *斜体* 标记。
    </hp>
    ...
    <hp indent={1} listStyleType="disc">
      输入 <htext code>1.</htext> 或 <htext code>1)</htext> 后跟 <htext code>空格</htext>
      来创建有序列表。
    </hp>
    <hp indent={1} listStyleType="disc">
    ...
    <hp indent={1} listStyleType="disc">
      输入 <htext code>###</htext> 后跟 <htext code>空格</htext> 来创建三级标题。
    </hp>
    <hp indent={1} listStyleType="disc">
      输入 <htext code>####</htext> 后跟 <htext code>空格</htext> 来创建四级标题。
    </hp>
    <hp indent={1} listStyleType="disc">
      输入 <htext code>#####</htext> 后跟 <htext code>空格</htext> 来创建五级标题。
    </hp>
    <hp indent={1} listStyleType="disc">
      输入 <htext code>######</htext> 后跟 <htext code>空格</htext> 来创建六级标题。
    </hp>
  </fragment>
);
