...
export const codeBlockValue: any = (
  <fragment>
    <hh2>Code Blocks</hh2>
    <hp>
      Showcase your code with syntax highlighting. Supports multiple programming languages with
    ...
    <hcodeblock lang="javascript">
      ...
      <hcodeline>{"    const response = await fetch(`/api/users/${userId}`);"}</hcodeline>
    ...
    <hcodeblock lang="python">
      ...
      <hcodeline />
      <hcodeline>{"    def get_task(self, index: int) -> Optional[str]:"}</hcodeline>
    ...
    <hcodeblock lang="css">
      ...
      <hcodeline>{"  box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);"}</hcodeline>
