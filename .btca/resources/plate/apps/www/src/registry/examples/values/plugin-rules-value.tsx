...
export const pluginRulesValue: any = (
  <fragment>
    ...
    <hp>
      <htext bold>Heading splitReset:</htext> Press Enter in middle of heading to split and reset
      new block to paragraph.
    </hp>
    <hh3>Press Enter after "Press" to see splitReset behavior</hh3>

    <hp>
      <htext bold>Blockquote with line breaks:</htext> Enter adds line breaks, Enter on empty lines
      resets to paragraph.
    </hp>
    <hblockquote>
    ...
    <hp>
      <htext bold>Code block reset:</htext> Backspace in empty code block resets to paragraph.
    </hp>
    ...
    <hp>
      <htext bold>List items:</htext> Backspace at start removes list formatting.
    </hp>
    ...
    <hp>
      <htext bold>Hard affinity (code):</htext> Use arrow keys around <htext code>code marks</htext>{" "}
      - requires two key presses to cross boundaries.
    </hp>

    <hp>
      <htext bold>Directional affinity:</htext> Use arrow keys around{" "}
      <htext superscript>superscript</htext> text - cursor affinity depends on movement direction.
    </hp>
    ...
    <hp>
      ...
      <ha url="https://example.com">this link</ha> - the link element will be automatically removed.
    </hp>
    ...
    <element type="hr" />
    <hp>Press Backspace at start - void element are selected rather than deleted.</hp>
