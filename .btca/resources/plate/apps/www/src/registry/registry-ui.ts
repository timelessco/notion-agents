...
export const uiComponents: Registry["items"] = [
  {
    dependencies: ["@platejs/ai", "@platejs/selection", "ai@6", "cmdk", "@faker-js/faker"],
  ...
  },
  {
    ...
    registryDependencies: ["@shadcn/calendar", "@shadcn/context-menu", "use-is-touch-device"],
  ...
  },
  {
    ...
    name: "select-editor",
    registryDependencies: ["editor", "@shadcn/command", "@shadcn/popover", "tag-node"],
    title: "Select Editor",
    type: "registry:ui",
  },
  {
    dependencies: ["@platejs/emoji", "@emoji-mart/data@1.2.1", "@radix-ui/react-popover"],
  ...
  },
  {
    ...
    files: [{ path: "ui/list-classic-toolbar-button.tsx", type: "registry:ui" }],
    meta: {
...
export const uiNodes: Registry["items"] = [
  ...
  },
  {
    ...
    registryDependencies: ["@shadcn/popover", "@shadcn/button", "@shadcn/select", "use-mobile"],
  ...
  },
  {
    ...
    meta: {
      docs: [{ route: "/docs/toc" }, { route: "https://pro.platejs.org/docs/components/toc-node" }],
