...
describe("streamInsertChunk", () => {
  ...
  describe("inline formatting", () => {
    it("applies marks that close in later chunks", () => {
      const editor = streamChunks(["This is a **bold", "**text", " with _italic_ marks"]);
    ...
    it("keeps marks that close at the end of a paragraph", () => {
      const editor = streamChunks(["hi ", "123", "\n\n 2233", "\n\n 4455", "**6677**"]);
    ...
    it("builds inline equations across chunk boundaries", () => {
      const editor = streamChunks(["inline math:\n\n", "$$a^2 ", "+ ", "b^2 ", "= ", "c^2$$"]);
    ...
    it("keeps inline html-like formatting once tags close", () => {
      const editor = streamChunks(["**bold**, _italic_,", "<u>", "underline", "</u>"]);
    ...
    it("preserves ordered list numbering after a paragraph break", () => {
      ...
      const output = (
        <fragment>
          ...
          <hp indent={1} listRestartPolite={2} listStart={2} listStyleType="decimal">
            <htext>2</htext>
          </hp>
        </fragment>
      ) as any;
