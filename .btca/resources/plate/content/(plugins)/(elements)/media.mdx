...
<API name="ImagePlugin">
  <APIOptions type="ImagePluginOptions">
    ...
    >
      ...
      `FileReader.readAsDataURL` - ArrayBuffer from clipboard data Returns: - URL string to uploaded
      image - Original data URL/ArrayBuffer if no upload needed - **Default:** Returns original
      input
    </APIItem>
