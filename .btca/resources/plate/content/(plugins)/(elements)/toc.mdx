...
<API name="TocPlugin">
  <APIOptions>
    <APIItem name="isScroll" type="boolean" optional>
      Enable scrolling behavior. - **Default:** `true`
    </APIItem>
    <APIItem name="topOffset" type="number" optional>
      Top offset when scrolling to heading. - **Default:** `80`
    </APIItem>
...
<API name="insertToc">
  <APIOptions type="InsertNodesOptions<SlateEditor>">Node insertion options.</APIOptions>
</API>
...
<API name="useTocElementState">
  <APIReturns>
    ...
    <APIItem
      ...
      type="(el: HTMLElement, id: string, behavior: ScrollBehavior) => void"
    >
...
<API name="useTocSideBar">
  <APIParameters>
    ...
    <APIItem
      name="onContentScroll"
      type="(options: { id: string; behavior?: ScrollBehavior; el: HTMLElement }) => void"
    >
      Content scroll handler.
    </APIItem>
  </APIParameters>
  <APIReturns>
    ...
    <APISubListItem
      parent="navProps"
      name="onContentClick"
      type="(e: React.MouseEvent<HTMLElement, MouseEvent>, item: Heading, behavior?: ScrollBehavior) => void"
    >
      TOC item click handler.
    </APISubListItem>
  </APIReturns>
