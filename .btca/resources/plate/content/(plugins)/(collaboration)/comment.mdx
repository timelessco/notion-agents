...
<KeyTable>
  <KeyTableItem hotkey="Cmd + Shift + M">Add a comment on the selected text.</KeyTableItem>
</KeyTable>
...
<API name="isCommentNodeById">
  ...
  <APIReturns type="boolean">Whether the node is a comment with the specified ID.</APIReturns>
</API>
