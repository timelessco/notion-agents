...
<KeyTable>
  <KeyTableItem hotkey="Cmd + Shift + S">Add a suggestion on the selected text.</KeyTableItem>
</KeyTable>
...
<API name="isBlockSuggestion">
  ...
  <APIReturns type="node is TSuggestionElement">Whether the node is a block suggestion.</APIReturns>
</API>
