...
<Accordion title="可以在商业项目中使用 Plate/Plate UI 吗？">
  可以。Plate（包括核心框架和 Plate
  UI）对个人和商业项目免费。无需署名，但我们欢迎您分享编辑器应用案例[在此](https://github.com/udecode/plate/discussions/2523)！
</Accordion>

<Accordion title="Plate UI 会取代 shadcn/ui 吗？">
  不会。Plate UI 扩展了 [shadcn/ui](https://ui.shadcn.com/) 和 [Radix
  UI](https://www.radix-ui.com/)，专门提供富文本编辑器设计组件。其他应用部分请继续使用 shadcn/ui
  或其他库。Plate UI 遵循相同规范，确保无缝集成。
</Accordion>
