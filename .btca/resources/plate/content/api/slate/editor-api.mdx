...
<API name="isCollapsed">
  <APIReturns type="boolean">True if the selection is collapsed, false otherwise.</APIReturns>
</API>
...
<API name="isExpanded">
  <APIReturns type="boolean">True if the selection is expanded, false otherwise.</APIReturns>
</API>
...
<API name="isReadOnly">
  <APIReturns type="boolean">True if the editor is read-only, false otherwise.</APIReturns>
</API>
...
<API name="isSaving">
  <APIReturns type="boolean">True if the editor is currently saving, false otherwise.</APIReturns>
</API>
