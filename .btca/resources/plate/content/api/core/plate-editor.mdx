    ...
    <APIItem name="dom" type="object">
      ...
      <APISubList>
        ...
        <APISubListItem parent="dom" name="currentKeyboardEvent" type="KeyboardEventLike | null">
          The current keyboard event being processed by the editor, or null if no event is being
          processed.
        </APISubListItem>
    ...
    <APIItem name="meta" type="object">
      ...
      <APISubList>
        ...
        <APISubListItem parent="meta" name="isNormalizing" type="boolean">
          Whether the editor is currently normalizing nodes. - **Default:** `false`
        </APISubListItem>
...
<API name="API">
  <APIMethods>
    ...
    <APIItem name="init" type="(options: InitOptions) => void">
      Initialize the editor value, selection, and normalization. Accepts options for auto-select,
      selection, normalization, value, and an `onReady` callback that provides context on
