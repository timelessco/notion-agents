...
<Callout>
  Once configured, try asking your AI: ```bash "Help me understand how the Plate AI plugin works"
  "How to create a custom plugin?" "What's new in the latest Plate version?" ```
</Callout>
