...
<Callout type="info">
  如果您没有使用 Next.js，请在继续之前参考官方的 [shadcn/ui
  安装指南](https://ui.shadcn.com/docs/installation) 了解您特定框架的安装方法。
</Callout>
...
<Callout type="note" title="插件依赖">
  手动安装 Plate 时，您需要为要使用的每个插件添加特定的包。例如，如果您想使用 `AIMenu` 组件，则需要
  `@platejs/ai` 及其依赖项。请查看每个组件的文档了解其所需的包，或使用 CLI 自动安装所需的包。
</Callout>
