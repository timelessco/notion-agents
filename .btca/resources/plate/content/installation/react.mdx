...
<Callout type="warning" title="Prerequisites">
  ...
  [shadcn/ui](https://ui.shadcn.com/docs/installation) (adapted for your framework, e.g., Vite) and
  [Plate UI](/docs/installation/plate-ui).
</Callout>
...
<Callout type="info">
  ...
  non-memoized version, use `createPlateEditor`.
</Callout>
