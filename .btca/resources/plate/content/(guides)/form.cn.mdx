...
export function RHFEditorForm() {
  const initialValue = [{ type: "p", children: [{ text: "来自 react-hook-form 的问候！" }] }];
...
export function EditorForm() {
  ...
  const form = useForm<FormValues>({
    defaultValues: {
      content: [{ type: "p", children: [{ text: "来自 shadcn/ui Form 的问候！" }] }],
    },
  });
...
function MyForm() {
  const form = useForm({
    defaultValues: {
      content: [{ type: "p", children: [{ text: "初始内容..." }] }],
    },
  });
...
<FormField
  ...
  render={({ field }) => (
    <FormItem>
      ...
      <FormControl>
        <Textarea placeholder="告诉我们一些关于你自己的信息" className="resize-none" {...field} />
      </FormControl>
      <FormDescription>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>个人简介</FormLabel>
              <FormControl>
                <EditorField {...field} placeholder="告诉我们一些关于你自己的信息..." />
              </FormControl>
              <FormDescription>
                您可以 <span>@提及</span> 其他用户和组织。
              </FormDescription>
