import { type SlateEditor, type TTagElement, type TTagProps, KEYS } from "platejs";
 ...
 */
export function isEqualTags<T extends TTagProps>(editor: SlateEditor, newTags?: T[]): boolean {
  const currentTags = [
