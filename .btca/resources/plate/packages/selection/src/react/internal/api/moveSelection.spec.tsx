...
describe("moveSelection", () => {
  ...
  beforeEach(() => {
    ...
    querySelectorSelectableSpy = spyOn(domUtils, "querySelectorSelectable").mockImplementation(
  ...
  describe("when only one block is selected", () => {
    it("maintain current selection if there is no block above/below", () => {
      ...
      editor.setOption(BlockSelectionPlugin, "selectedIds", new Set(["block3"]));
      editor.setOption(BlockSelectionPlugin, "anchorId", "block3");
  ...
  describe("when pressing arrow up with nested blocks", () => {
    it("select parent block if no previous sibling exists", () => {
      ...
      // Select child1
      editor.setOption(BlockSelectionPlugin, "selectedIds", new Set(["child1"]));
  ...
  describe("when pressing arrow up with complex nested blocks", () => {
    beforeEach(() => {
      ...
      editor.setOption(BlockSelectionPlugin, "isSelectable", (node) => node.type !== "column");
    });

    it("move to previous sibling when not first child", () => {
      // Select child2
      editor.setOption(BlockSelectionPlugin, "selectedIds", new Set(["child2"]));
    ...
    it("move to parents previous block if first child and skipping columns", () => {
      // Select grandchild2
      editor.setOption(BlockSelectionPlugin, "selectedIds", new Set(["grandchild2"]));
    ...
    it("handle deeper nesting with non-selectable parents", () => {
      ...
      // Select grandchild1
      editor.setOption(BlockSelectionPlugin, "selectedIds", new Set(["grandchild1"]));
