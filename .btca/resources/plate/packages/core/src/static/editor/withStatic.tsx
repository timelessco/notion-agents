...
import { type CreateSlateEditorOptions, type WithSlateOptions, withSlate } from "../../lib/editor";
...
const withStatic = <V extends Value = Value, P extends AnyPluginConfig = CorePlugin>(
  editor: Editor,
...
export const createStaticEditor = <
  V extends Value = Value,
  P extends AnyPluginConfig = CorePlugin,
>({ editor = createEditor(), ...options }: CreateStaticEditorOptions<V, P> = {}) =>
  withStatic<V, P>(editor, options);
