...
const renderComponentToHtml = <P extends {}>(
  ...
  props: P,
): string => decode(ReactDOMServer.renderToStaticMarkup(React.createElement(Component, props)));

export type SerializeHtmlOptions<T extends PlateStaticProps = PlateStaticProps> = {
 ...
 * `EditorStatic`).
 */
export const serializeHtml = async <T extends PlateStaticProps = PlateStaticProps>(
  editor: SlateEditor,
  {
