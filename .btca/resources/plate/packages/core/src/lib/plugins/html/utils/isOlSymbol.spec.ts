...
describe("isOlSymbol", () => {
  it("Recognizes symbols of unordered lists", () => {
    ...
    unorderedListSymbols.forEach((symbol) => {
      ...
      expect(isOlSymbol(`${NO_BREAK_SPACE}${symbol}${NO_BREAK_SPACE}`)).toBe(false);
      ...
      expect(isOlSymbol(`${NO_BREAK_SPACE}${symbol}${NO_BREAK_SPACE}${SPACE}`)).toBe(false);
  ...
  it("Recognizes symbols of ordered lists", () => {
    ...
    orderedListSymbols.forEach((symbol) => {
      ...
      expect(isOlSymbol(`${NO_BREAK_SPACE}${symbol}${NO_BREAK_SPACE}`)).toBe(true);
      ...
      expect(isOlSymbol(`${NO_BREAK_SPACE}${symbol}${NO_BREAK_SPACE}${SPACE}`)).toBe(true);
