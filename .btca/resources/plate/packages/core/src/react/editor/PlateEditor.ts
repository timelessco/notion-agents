import type { DescendantIn, EditorApi, EditorTransforms, Operation, Value } from "@platejs/slate";
...
import type { AnyEditorPlatePlugin, EditorPlatePlugin, Shortcuts } from "../plugin/PlatePlugin";
...
export type KeyofPlugins<T extends AnyPluginConfig> = (string & {}) | InferKey<PlateCorePlugin | T>;
