...
import type { InferConfig, PlatePlugin, PlatePluginContext } from "./PlatePlugin";
...
export function getEditorPlugin<P extends AnyPluginConfig | PlatePlugin<AnyPluginConfig>>(
  editor: PlateEditor,
