...
- [#1871](https://github.com/udecode/plate/pull/1871) by [@zbeyens](https://github.com/zbeyens) –
  ...
  >
    extends PlateProviderEffectsProps<V, E>, Partial<Pick<PlateStoreState<V, E>, "id" | "editor">> {
    /**
...
- [#1234](https://github.com/udecode/plate/pull/1234) by [@zbeyens](https://github.com/zbeyens) – Breaking changes:
  ...
  // After
  export type X<T = {}, P = {}> = (editor: PlateEditor<T>, plugin: WithPlatePlugin<T, P>) => Y;
  ```
  ...
  interface PlatePlugin {
    editor?: Nullable<{
      insertData?: {
        ...
        getFragment?: (options: PlatePluginInsertDataOptions) => TDescendant[] | undefined;
