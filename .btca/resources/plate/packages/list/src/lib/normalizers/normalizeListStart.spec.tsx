...
const createEditor = ({
  ...
  createSlateEditor({
    plugins: [BaseParagraphPlugin, BaseIndentPlugin, pages ? listPluginPage : BaseListPlugin],
    ...
    describe("when configured to continue lists across multiple pages", () => {
      ...
      it("respects listRestart", () => {
        const input = [
          ...
          <element type="page">{createItem("1", { listRestart: 1, listStart: 2 })}</element>,
        ];
  ...
  describe("when normalizing after operations", () => {
    ...
    describe("set_node", () => {
      ...
      it("splits a list", () => {
        ...
        editor.tf.setNodes({ indent: undefined, listStyleType: undefined }, { at: [2] });
