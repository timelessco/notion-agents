...
describe("encodeUrlIfNeeded", () => {
  it("does not transform URL containing no special characters", () => {
    const url = "https://username:password@example.com:1234/path?query=value#fragment";
  ...
  it("encodes URL containing special characters", () => {
    ...
    expect(encodeUrlIfNeeded(url)).toEqual("https://example.com/path?query=%E3%81%82");
  });
